...
DROP TABLE IF EXISTS GOVERNMENT_INVENTORY_2003;
...
(
	...
	GOVERNMENT_QUOTA_AMOUNT NUMERIC(18,5),
	GOVERNMENT_QUOTA_TOTAL_PRICE NUMERIC(18,5),
...
(
	...
	RECORD_UNIT VARCHAR(10),
	RECORD_PRICE NUMERIC(18,5),
	RECORD_AMOUNT NUMERIC(18,5) NOT NULL,
	RECORD_TOTAL_PRICE NUMERIC(18,5),
...
(
	...
	FILE_PUBLISH_DATE TIMESTAMP,
	FILE_EFFECTIVE_DATE TIMESTAMP,
	EFFECTIVE BOOLEAN
)DEFAULT CHARSET=UTF8;

CREATE TABLE GOVERNMENT_INVENTORY_2003
(
	ID BIGINT(15) PRIMARY KEY NOT NULL AUTO_INCREMENT,
	PROJECT_CLASS_NAME VARCHAR(20),
	PROJECT_CLASS_NUM VARCHAR(20), 
