...
public class SearchDataCondition extends VoBase {
	...
	/**
	 * @param projectDateAfter the projectDateAfter to set
	 */
	...
	/**
	 * @param projectDateBefore the projectDateBefore to set
	 */
	...
	/**
	 * @param priceSourceType the priceSourceType to set
	 */
	...
	/**
	 * @param dataDateAfter the dataDateAfter to set
	 */
	public void setDataDateAfter(Timestamp dataDateAfter) {
		this.dataDateAfter = dataDateAfter;
	}
	/**
	 * @param dataDateBefore the dataDateBefore to set
	 */
	...
	/**
	 * @param filePublishYear the filePublishYear to set
	 */
	...
	/**
	 * @param filePublishMonth the filePublishMonth to set
	 */
	...
	/**
	 * @param fileEffectiveYear the fileEffectiveYear to set
	 */
	...
	/**
	 * @param fileEffectiveMonth the fileEffectiveMonth to set
	 */
	...
	/**
	 * @param filePublishDateFrom the filePublishDateFrom to set
	 */
	...
	/**
	 * @param filePublishDateTo the filePublishDateTo to set
	 */
	...
	/**
	 * @param fileEffectiveDateFrom the fileEffectiveDateFrom to set
	 */
	...
	/**
	 * @param fileEffectiveDateTo the fileEffectiveDateTo to set
	 */
