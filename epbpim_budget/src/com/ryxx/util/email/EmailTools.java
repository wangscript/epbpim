...
public class EmailTools {
	 ...
	 * @return
	 */
	public static String generateFindPasswordContent(String realName,
			String newPassword) {
		StringBuilder sb = new StringBuilder(Constants.EMAIL_NORMAI_USER_TITLE1
				+ realName + "," + "<br>" + Constants.EMAIL_FIND_PASSWORD
				+ "<br>");
