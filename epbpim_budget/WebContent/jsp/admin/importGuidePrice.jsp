				...
				<div class="mainbar">
					...
					<div class="entry">
						...
						<s:form action="uploadGuideData.do" method="post"
							name="uploadUserCustomDataForm" id="uploadUserCustomDataForm"
							enctype="multipart/form-data">
							<ul class="fullScreenUl">
								<li class="width100Li">省：</li>
								<li>
									<s:select cssClass="width150Select" id="uploadUserCustomDataProvice" name="uploadUserCustomDataProvice" 
							...
							<ul class="fullScreenUl">
								...
								<li class="width200Li"><s:file name="uploadUserCustomData"
									...
									id="uploadUserCustomDataInput"> <!-- <input type="button" value="选择" class="button"
		onClick="getObject('uploadUserCustomDataFile').click()"> -->
								</li>
							</ul>
							<ul class="fullScreenUl">
								<li class="width100Li"><input type="button"
									onclick="upload('uploadUserCustomData');" class="button"
									value="上传"></li>
			...
			if (currProvince != 0) {
				if (cityArray[i][0] == currProvince) {
					...
					for (j = 1; j < tmpcityArray.length + 1; j++) {
						//填充 城市 下拉选单
						document.getElementById(optionId).options[j] = new Option(
								tmpcityArray[j - 1], tmpcityArray[j - 1]);
					}
				}
			}
		}
