...
<script type="text/javascript">
	...
	function chooseFile() 
	{
		...
		var fileName = filePath.substring(filePath.lastIndexOf('\\') + 1,
				filePath.length);
		document.getElementById('guideData.guideDataFileName').value = fileName;
	}
</script>
<style>
.WithBreaks {
		...
		<div class="content">
			<div class="content_resize">
				<div class="mainbar">
					...
					<div class="entry">
						<s:form action="importGuideData.do" method="post" id="importGuideDataForm" enctype="multipart/form-data">
							...
							<ul class="fullScreenUl">
								...
								<li class="width100Li"><input class="Wdate width100Input"
									...
									name="guideData.guideDataDatePage"
							...
							<ul class="fullScreenUl">
								...
								<li class="width300Li"><s:file name="uploadFile" cssClass="width300Input"
									...
									type="hidden" name="guideData.guideDataFileName"
									id="guideData.guideDataFileName"></li>
							</ul>
							<ul class="fullScreenUl">
