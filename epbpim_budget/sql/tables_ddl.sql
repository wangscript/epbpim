...
(
	...
	GUIDEDATA_TYPE INT(5),
	GUIDEDATA_CLASS VARCHAR(10) NOT NULL,
	...
	CONSTRAINT GUIDE_PRICE_FK1 FOREIGN KEY (GUIDEDATA_PROVICE) REFERENCES PROVINCE_CITY(PROVINCE_ID),
	CONSTRAINT GUIDE_PRICE_FK2 FOREIGN KEY (GUIDEDATA_CLASS) REFERENCES MAJOR(ID)
)DEFAULT CHARSET=UTF8;
