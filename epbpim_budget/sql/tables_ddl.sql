...
-- DROP TABLE IF EXISTS GUIDE_DATA;
...
(
	...
	EMAIL  VARCHAR(100), 								   
	ROLE_ID VARCHAR(30),		 -- 对应roleEnum    1普通用户，2企业用户，3管理员， 4专家
...
CREATE TABLE PRICEPACKAGE_FILE (
	...
	PRICEPACKAGE_PROVICE INT(10),
	PRICEPACKAGE_TYPE VARCHAR(5),
	PRICEPACKAGE_DATE TIMESTAMP NOT NULL DEFAULT '0000-00-00',
	UPLOAD_DATE TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00',
	PRIMARY KEY (ID),
	CONSTRAINT PRICEPACKAGE_FILE_FK1 FOREIGN KEY (PRICEPACKAGE_PROVICE) REFERENCES PROVINCE_CITY(PROVINCE_ID),
	CONSTRAINT PRICEPACKAGE_FILE_FK2 FOREIGN KEY (PRICEPACKAGE_TYPE) REFERENCES MAJOR(ID)
) ENGINE=MYISAM DEFAULT CHARSET = UTF8;
...
(
	...
	PERIODICAL_PROVICE INT(10),
	PERIODICAL_TYPE VARCHAR(5),
	PERIODICAL_URL VARCHAR(300),
	PERIODICAL_DATE TIMESTAMP NOT NULL DEFAULT '0000-00-00',
	UPLOAD_DATE TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00',
	PRIMARY KEY (ID),
	CONSTRAINT PERIODICAL_FILE_FK1 FOREIGN KEY (PERIODICAL_PROVICE) REFERENCES PROVINCE_CITY(PROVINCE_ID),
	CONSTRAINT PERIODICAL_FILE_FK2 FOREIGN KEY (PERIODICAL_TYPE) REFERENCES MAJOR(ID)
)ENGINE=MYISAM DEFAULT CHARSET = UTF8;

CREATE TABLE GUIDE_PRICE
(
	ID BIGINT(15) NOT NULL AUTO_INCREMENT,
	GUIDEPRICE_PROVICE INT(10),
	GUIDEPRICE_TYPE VARCHAR(10),    -- 类型  (大类)
	GUIDEPRICE_CLASS VARCHAR(20),   -- 分类  (小类)
	NAME VARCHAR(200),
	UNIT VARCHAR(20),
	PRICE NUMERIC(10,2) NOT NULL,
	PRICE_COMMENT VARCHAR(255),
	GUIDEPRICE_DATE TIMESTAMP NOT NULL DEFAULT '0000-00-00',
	UPLOAD_DATE TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00',
	COMMENT VARCHAR(255),
	PRIMARY KEY (ID),
	CONSTRAINT GUIDE_PRICE_FK1 FOREIGN KEY (GUIDEPRICE_PROVICE) REFERENCES PROVINCE_CITY(PROVINCE_ID)
)ENGINE=MYISAM DEFAULT CHARSET = UTF8;

CREATE TABLE GUIDE_DATA 
(
	ID BIGINT(15) PRIMARY KEY NOT NULL AUTO_INCREMENT,
	GUIDEDATA_PROVICE INT(10),	 
	GUIDEDATA_TYPE VARCHAR(10) NOT NULL,	
	...
	GUIDEDATA_CLASS VARCHAR(10),
	GUIDEDATA_DATE TIMESTAMP NOT NULL DEFAULT '0000-00-00',
	IMPORT_DATE TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00',
	CONSTRAINT GUIDE_DATA_FK1 FOREIGN KEY (GUIDEDATA_PROVICE) REFERENCES PROVINCE_CITY(PROVINCE_ID),
	CONSTRAINT GUIDE_DATA_FK2 FOREIGN KEY (GUIDEDATA_CLASS) REFERENCES MAJOR(ID)
)ENGINE=MYISAM DEFAULT CHARSET=UTF8;
...
(
	...
	BOOK_REAL_NAME VARCHAR(1000),
	BOOK_PROVICE INT(10),
	CONSTRAINT BOOK_FK1 FOREIGN KEY (BOOK_PROVICE) REFERENCES PROVINCE_CITY(PROVINCE_ID)
)ENGINE=MYISAM DEFAULT CHARSET = UTF8;

CREATE TABLE PRICE_INDEX_PICTURE
(
	ID BIGINT(15) PRIMARY KEY NOT NULL AUTO_INCREMENT,
	FILE_NAME VARCHAR(1000),
	REAL_NAME VARCHAR(1000),
	PRICE_INDEX_DATE TIMESTAMP NOT NULL DEFAULT '0000-00-00',
	PRICE_INDEX_PROVICE INT(10),
	PRICE_INDEX_PICTURE_TYPE VARCHAR(10) NOT NULL,	
	CONSTRAINT PRICE_INDEX_PICTURE_FK1 FOREIGN KEY (PRICE_INDEX_PROVICE) REFERENCES PROVINCE_CITY(PROVINCE_ID),
	CONSTRAINT PRICE_INDEX_PICTURE_FK2 FOREIGN KEY (PRICE_INDEX_PICTURE_TYPE) REFERENCES MAJOR(ID)
)ENGINE=MYISAM DEFAULT CHARSET = UTF8;

CREATE TABLE PRICE_HIGH_LOW_TOP_PICTURE
(
	ID BIGINT(15) PRIMARY KEY NOT NULL AUTO_INCREMENT,
	FILE_NAME VARCHAR(1000),
	REAL_NAME VARCHAR(1000),
	PRICE_HIGH_LOW_TOP_DATE TIMESTAMP NOT NULL DEFAULT '0000-00-00',
	PRICE_HIGH_LOW_TOP_PROVICE INT(10),
	PRICE_HIGH_LOW_TOP_PICTURE_TYPE VARCHAR(10) NOT NULL,	
	CONSTRAINT PRICE_HIGH_LOW_TOP_PICTURE_FK1 FOREIGN KEY (PRICE_HIGH_LOW_TOP_PROVICE) REFERENCES PROVINCE_CITY(PROVINCE_ID),
	CONSTRAINT PRICE_HIGH_LOW_TOP_PICTURE_FK2 FOREIGN KEY (PRICE_HIGH_LOW_TOP_PICTURE_TYPE) REFERENCES MAJOR(ID)
)ENGINE=MYISAM DEFAULT CHARSET = UTF8;
...
(
	...
	ANSWER VARCHAR(1000),
	QUESTION_USER_ID BIGINT(15),
	ANSWER_USER_ID BIGINT(15),
	CONSTRAINT QUESTION_ANSWER_FK1 FOREIGN KEY (QUESTION_USER_ID) REFERENCES USER_INFO(USER_ID),
	CONSTRAINT QUESTION_ANSWER_FK2 FOREIGN KEY (ANSWER_USER_ID) REFERENCES USER_INFO(USER_ID)
)ENGINE=MYISAM DEFAULT CHARSET = UTF8;
