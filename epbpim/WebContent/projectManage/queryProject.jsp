			...
			<div class="searchResult" id="searchResult">
				...
				<s:iterator value="projectInfoList" status="st">
					<ul class="fullScreenUl" style='background-color:<s:if test="projectInfo.queryType==3 && #st.odd">#F0F0F0</s:if><s:elseif test="projectInfo.queryType==3 && #st.even">#C0C0C0</s:elseif>'>
						...
						<li class="width50Li">
								<input type="button" <s:if test="projectInfo.queryType!=3 && (status == 1 || status == 2)">disabled</s:if> onclick='preModProject(<s:property value="id" />);' class="mediumRightButton" class="button" value='<s:if test="status == 2">结项</s:if><s:else>修改</s:else>'>
						</li>
						<li class="width50Li">
