...
public class ParamTools
{
     ...
     * @return
     */
    public static boolean getBoolParameter(HttpServletRequest request, String param, boolean defaultvalue)
    {
     ...
     * @return
     */
    public static java.util.Date getDateParameter(HttpServletRequest request, String param, java.util.Date defaultValue)
    {
        String value = request.getParameter(param);
        if (null == value)
        {
     ...
     * @return
     */
    public static java.util.Date getDateParameter(HttpServletRequest request, String param, String defaultValue)
    {
     ...
     * @return
     */
    public static java.util.Date getDateParameter(HttpServletRequest request, String param)
    {
        String value = request.getParameter(param);
        ...
        java.text.SimpleDateFormat formator = new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        java.util.Date result;
        try
        {
            result = formator.parse(value);
     ...
     * @return
     */
    public static String getSessionValue(HttpSession session, String attribute, String defaultValue)
    {
        String svalue = null;
        try
        {
     ...
     * @return
     */
    public static long getLongSessionValue(HttpSession session, String attribute, long defaultValue)
    {
        ...
        throws NumberFormatException
    {
        try
        {
            long value = Long.parseLong((String)session.getAttribute(attribute));
            return value;
        }
        catch (NumberFormatException ex)
        {
        ...
        throws IOException
    {
        ...
        FileInputStream in = new FileInputStream(request.getRealPath("") + Constants.PROPERTIES_FILE_PATH);
        prop.load(in);
