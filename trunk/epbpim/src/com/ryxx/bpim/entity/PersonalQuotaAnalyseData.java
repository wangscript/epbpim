 ...
 * author Delgado
 */
public class PersonalQuotaAnalyseData extends VoBase {
	/**
	 * 
	 */
	private static final long serialVersionUID = 244165927778297005L;
	private Long id;
	private String area;
	...
	private Double totalUserProjcetPrice;
	private Double totalGovernmentQuotaPrice;
	private Double totalGovernmentGuidePrice;
	private Double totalUserCustomPrice;
	...
	/**
	 * @return the totalUserProjcetPrice
	 */
	public Double getTotalUserProjcetPrice() {
		return totalUserProjcetPrice;
	}
	/**
	 * @param totalUserProjcetPrice the totalUserProjcetPrice to set
	 */
	public void setTotalUserProjcetPrice(Double totalUserProjcetPrice) {
		this.totalUserProjcetPrice = totalUserProjcetPrice;
	}
	/**
	 * @return the totalGovernmentQuotaPrice
	 */
	public Double getTotalGovernmentQuotaPrice() {
		return totalGovernmentQuotaPrice;
	}
	/**
	 * @param totalGovernmentQuotaPrice the totalGovernmentQuotaPrice to set
	 */
	public void setTotalGovernmentQuotaPrice(Double totalGovernmentQuotaPrice) {
		this.totalGovernmentQuotaPrice = totalGovernmentQuotaPrice;
	}
	/**
	 * @return the totalGovernmentGuidePrice
	 */
	public Double getTotalGovernmentGuidePrice() {
		return totalGovernmentGuidePrice;
	}
	/**
	 * @param totalGovernmentGuidePrice the totalGovernmentGuidePrice to set
	 */
	public void setTotalGovernmentGuidePrice(Double totalGovernmentGuidePrice) {
		this.totalGovernmentGuidePrice = totalGovernmentGuidePrice;
	}
	/**
	 * @return the totalUserCustomPrice
	 */
	public Double getTotalUserCustomPrice() {
		return totalUserCustomPrice;
	}
	/**
	 * @param totalUserCustomPrice the totalUserCustomPrice to set
	 */
	public void setTotalUserCustomPrice(Double totalUserCustomPrice) {
		this.totalUserCustomPrice = totalUserCustomPrice;
	}
