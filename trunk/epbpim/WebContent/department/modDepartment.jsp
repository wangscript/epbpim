	...
	<div id="main"><jsp:include page="../main/mainHeader.jsp" />
		<div class="content">
			<div class="content_resize">
				<div class="mainbar">
					<s:form action="modAdminDept.do" onsubmit="return validate(this);" method="post">
						<input type="hidden" name="adminDept.id" value="<s:property value='adminDept.id' />"/>
						<h3 class="title">
						...
						<div id="addDepartmentTable">
							<ul class="fullScreenUl">
								<li class="width200Li"><label class="width4Lb"><s:text
									...
									maxlength="50" value="<s:property value='adminDept.name' />"/>
							...
							<ul class="fullScreenUl" style="height: 200px">
								<li class="width600Li"><label class="width4Lb"><s:text
										...
										style="height: 150px; width: 300px"><s:property value="adminDept.remark" /></textarea>
