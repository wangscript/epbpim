				...
				<div class="mainbar">
					...
					<div class="entry">
						...
						<s:form action="deleteGuideData.do" method="post"
							name="deleteGuideDataForm" id="deleteGuideDataForm">
							<ul class="fullScreenUl">
								<li class="width50Li"><label class="width1Lb">省：</label>
								</li>
								<li class="width200Li"><select id="provice" name="provice"
							...
							<ul class="fullScreenUl">
								<li class="width50Li"><label class="width1Lb">年：</label>
								</li>
								<li class="width200Li"><select id="year"
									class="width150Select" name="year">
										<option value="0">---------请选择---------</option>
							...
							<ul class="fullScreenUl">
								<li><input type="button" onclick="deleteData();"
