...
<script type="text/javascript">
	...
	function chooseFile() 
	{
		...
		var fileName = filePath.substring(filePath.lastIndexOf('\\') + 1,
				filePath.length);
		document.getElementById('book.bookRealName').value = fileName;
	}
</script>
</head>
	...
	<div id="main"><jsp:include page="adminHeader.jsp" />
		<div class="content">
			<div class="content_resize">
				<div class="mainbar">
					<h4 class="title">书籍上传</h4>
					<div id="">
						<s:form action="uploadBook.do" id="uploadBookForm"
							enctype="multipart/form-data" method="post">
							<ul class="fullScreenUl">
								<li class="width100Li">省份：</li>
								<li class="width200Li">
									<s:select cssClass="width150Select" id="book.provinceCity.id" name="book.provinceCity.id"
							...
							<ul class="fullScreenUl">
								...
								<li class="width300Li"><s:file name="uploadFile" cssClass="width300Input"
									...
									type="hidden" name="book.bookRealName"
									id="book.bookRealName"></li>
							</ul>
							<ul class="fullScreenUl">
