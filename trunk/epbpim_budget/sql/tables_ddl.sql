...
CREATE TABLE ADMIN_MENU (
  ...
  PRIMARY KEY  (MENU_ID),
  CONSTRAINT ADMIN_MENU_FK1 FOREIGN KEY (MENU_REGION) REFERENCES PROVINCE_CITY(PROVINCE_ID)
...
(
	...
	PAY_DATE TIMESTAMP NOT NULL DEFAULT '0000-00-00', 
	EXPIRE_DATE TIMESTAMP NOT NULL DEFAULT '0000-00-00',
