...
(
	...
	ADMIN_USER_SEX INT(1) NOT NULL,					 -- 性别
	ADMIN_USER_IDCARD VARCHAR(20) NOT NULL,			 -- 身份证
	ADMIN_MOBILE_PHONE VARCHAR(50),					 -- 手机
	ADMIN_USER_STATUS INT(1),					 		 -- 状态。UserStatusEnum里的key 
	...
	ADMIN_ROLE_ID INT(10),					 		 -- 对应adminRoleEnum
	ADMIN_ENTERPRISE_ID BIGINT(15) NOT NULL,
	CONSTRAINT USER_INFO_FK1 FOREIGN KEY (ENTERPRISE_ID) REFERENCES ENTERPRISE_INFO(ENTERPRISE_ID)
) ENGINE=MyISAM DEFAULT CHARSET=UTF8;
