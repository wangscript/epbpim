...
function setValue(){
	var uploadUserProjectDataYear = "<s:property value='uploadUserProjectDataYear'/>";
	document.getElementById("uploadUserProjectDataYear").value = uploadUserProjectDataYear;
	var uploadUserProjectDataMonth = "<s:property value='uploadUserProjectDataMonth'/>";
	document.getElementById("uploadUserProjectDataMonth").value = uploadUserProjectDataMonth;
	var uploadUserProjectDataProvice = "<s:property value='uploadUserProjectDataProvice'/>";
	document.getElementById("uploadUserProjectDataProvice").value = uploadUserProjectDataProvice;
	getCity(uploadUserProjectDataProvice,"uploadUserProjectDataCity");
	var uploadUserProjectDataCity = "<s:property value='uploadUserProjectDataCity'/>";
	document.getElementById("uploadUserProjectDataCity").value = uploadUserProjectDataCity;
	var uploadUserProjectDataType = "<s:property value='uploadUserProjectDataType'/>";
	document.getElementById("uploadUserProjectDataType").value = uploadUserProjectDataType;
...
<div class="mainbar">
<h3 class="title">导入历史数据</h3>
<div id="uploadDataPanel">

<s:form action="uploadUserProjectData.do" method="post" name="uploadUserProjectDataForm" id="uploadUserProjectDataForm"  enctype="multipart/form-data">
<ul>
	<li style="width:200px;"><label class="lb">年：</label><select id="uploadUserProjectDataYear" name="uploadUserProjectDataYear"
		style="width: 90px;">
	...
	<li><label class="lb">月：</label><select id="uploadUserProjectDataMonth" name="uploadUserProjectDataMonth"
		style="width: 90px;">
		<option value="0" selected="selected">--请选择--</option>
	...
	<ul>
	<li style="width:200px;"><label class="lb">省：</label><select id="uploadUserProjectDataProvice" name="uploadUserProjectDataProvice"
		onChange="getCity(this.options[this.selectedIndex].value,'uploadUserProjectDataCity')"
		style="width: 150px;">
		<option value="0" selected="selected">---------请选择---------</option>
	...
	<li><label class="lb">市：</label><select id="uploadUserProjectDataCity" name="uploadUserProjectDataCity"
		style="width: 90px;">
		<option value="0" selected="selected">---请选择---</option>
	</select></li>
	</ul>
	<ul>
	<li><label class="lb">数据类别：</label><select id="uploadUserProjectDataType" name="uploadUserProjectDataType"
		style="width: 90px;">
...
function validate(type){
	var uploadUserProjectDataYear = document.getElementById(type+"Year").value;
	if(uploadUserProjectDataYear == 0){
		alert("请选择年");
		return false;
	}
	var uploadUserProjectDataMonth = document.getElementById(type+"Month").value;
	if(uploadUserProjectDataMonth == 0){
		alert("请选择月");
		return false;
	}
	var uploadUserProjectDataType = document.getElementById(type+"Type").value;
	if(uploadUserProjectDataType == 0){
		alert("请选择上传数据类型");
		return false;
	}
