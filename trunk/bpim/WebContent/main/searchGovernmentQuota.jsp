...
<div class="mainbar">
<h3 class="title">定额查询</h3>
<div id="searchCondition">
		<ul>
		<li style="width:200px;"><label class="lb">省：</label><select id="provice" name="condition.provice"
		style="width: 150px;">
	...
	<li style="width:150px;">定额类别：<select id="quotaClass" name="condition.quotaClass"
		style="width: 80px;"> 
		<option value="0">--请选择--</option>
	...
	<s:iterator value="datas" status="st">
		<ul id="<s:property value='id'/>">
			...
			<li style="width: 330px"><s:if
				...
				<s:property value="governmentQuotaName.substring(0, 23)+'...'" />
			</s:if> <s:else>
			...
			<li style="width: 50px">
			<a target="blank" href="viewGovernmentQuotaDetail.do?id=<s:property value='id'/>">查看</a>
			</li>
		</ul>
	</s:iterator>
	<ul>
