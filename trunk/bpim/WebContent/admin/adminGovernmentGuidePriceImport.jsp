...
<s:form action="uploadGuideData.do" method="post" name="uploadUserCustomDataForm" id="uploadUserCustomDataForm"  enctype="multipart/form-data">
	<ul>
	...
	<li><input type="button"
		...
		class="button" style="width: 70px;" value="确定上传"></li>
