------------------------------------------------------
-- Export file for user G4STUDIO                    --
-- Created by Administrator on 2012-08-25, 22:29:37 --
------------------------------------------------------
...
prompt
prompt Creating table EAUSERMENUPART
prompt =============================
prompt
...
comment on column EA_DEMO_FCF.product
  is '产品';
alter table EA_DEMO_FCF
  add primary key (FCFID);
...
prompt
prompt Creating table EA_DEMO_UPLOAD
prompt =============================
prompt
...
prompt ==============================
prompt
create or replace procedure g4_prc_demo(
        prm_myname                         IN     VARCHAR2,
...
values ('001', 'G4集成与开发平台', '0', '01        ', 1, '0', null, '1');
insert into EADEPT (deptid, deptname, parentid, customid, sortno, leaf, remark, enabled)
...
insert into EAEVENT (eventid, userid, account, username, description, activetime, requestpath, methodname, costtime)
values ('100000000033162', '10000001', 'developer', '开发人员', '登录系统', 20120825145216, '/G4Studio/login.ered', 'login', null);
insert into EAEVENT (eventid, userid, account, username, description, activetime, requestpath, methodname, costtime)
values ('100000000033164', '10000001', 'developer', '开发人员', '开发人员[developer]调用了Action方法[login]', 20120825145217, '/G4Studio/login.ered', 'login', 1252);
insert into EAEVENT (eventid, userid, account, username, description, activetime, requestpath, methodname, costtime)
values ('100000000033166', '10000001', 'developer', '开发人员', '开发人员[developer]调用了Action方法[indexInit]', 20120825145217, '/G4Studio/index.ered', 'indexInit', 872);
insert into EAEVENT (eventid, userid, account, username, description, activetime, requestpath, methodname, costtime)
values ('100000000033168', '10000001', 'developer', '开发人员', '开发人员[developer]调用了Action方法[preferencesInit]', 20120825145219, '/G4Studio/index.ered', 'preferencesInit', 590);
insert into EAEVENT (eventid, userid, account, username, description, activetime, requestpath, methodname, costtime)
values ('100000000033170', '10000001', 'developer', '开发人员', '开发人员[developer]打开了菜单[JDBC执行监控]', 20120825145225, '/G4Studio/jdbcMonitor.ered', 'jdbcInit', 293);
insert into EAEVENT (eventid, userid, account, username, description, activetime, requestpath, methodname, costtime)
values ('100000000033172', '10000001', 'developer', '开发人员', '开发人员[developer]调用了Action方法[queryMonitorData]', 20120825145225, '/G4Studio/jdbcMonitor.ered', 'queryMonitorData', 175);
insert into EAEVENT (eventid, userid, account, username, description, activetime, requestpath, methodname, costtime)
values ('100000000033174', '10000001', 'developer', '开发人员', '开发人员[developer]调用了Action方法[deleteMonitorDatas]', 20120825145228, '/G4Studio/jdbcMonitor.ered', 'deleteMonitorDatas', 113);
insert into EAEVENT (eventid, userid, account, username, description, activetime, requestpath, methodname, costtime)
values ('100000000033176', '10000001', 'developer', '开发人员', '开发人员[developer]调用了Action方法[queryMonitorData]', 20120825145228, '/G4Studio/jdbcMonitor.ered', 'queryMonitorData', 37);
insert into EAEVENT (eventid, userid, account, username, description, activetime, requestpath, methodname, costtime)
values ('100000000033178', '10000001', 'developer', '开发人员', '开发人员[developer]打开了菜单[系统异常监控]', 20120825145238, '/G4Studio/beanMonitor.ered', 'init', 312);
insert into EAEVENT (eventid, userid, account, username, description, activetime, requestpath, methodname, costtime)
values ('100000000033180', '10000001', 'developer', '开发人员', '开发人员[developer]调用了Action方法[queryMonitorDatas]', 20120825145238, '/G4Studio/beanMonitor.ered', 'queryMonitorDatas', 51);
insert into EAEVENT (eventid, userid, account, username, description, activetime, requestpath, methodname, costtime)
values ('100000000033182', '10000001', 'developer', '开发人员', '开发人员[developer]调用了Action方法[deleteMonitorDatas]', 20120825145247, '/G4Studio/beanMonitor.ered', 'deleteMonitorDatas', 38);
insert into EAEVENT (eventid, userid, account, username, description, activetime, requestpath, methodname, costtime)
values ('100000000033184', '10000001', 'developer', '开发人员', '开发人员[developer]调用了Action方法[queryMonitorDatas]', 20120825145247, '/G4Studio/beanMonitor.ered', 'queryMonitorDatas', 45);
insert into EAEVENT (eventid, userid, account, username, description, activetime, requestpath, methodname, costtime)
values ('100000000033138', '10000001', 'developer', '开发人员', '开发人员[developer]调用了Action方法[login]', 20120820232329, '/G4Studio/login.ered', 'login', 469);
insert into EAEVENT (eventid, userid, account, username, description, activetime, requestpath, methodname, costtime)
values ('100000000033140', '10000001', 'developer', '开发人员', '开发人员[developer]调用了Action方法[indexInit]', 20120820232330, '/G4Studio/index.ered', 'indexInit', 531);
insert into EAEVENT (eventid, userid, account, username, description, activetime, requestpath, methodname, costtime)
values ('100000000033136', '10000001', 'developer', '开发人员', '登录系统', 20120820232329, '/G4Studio/login.ered', 'login', null);
insert into EAEVENT (eventid, userid, account, username, description, activetime, requestpath, methodname, costtime)
values ('100000000033142', '10000001', 'developer', '开发人员', '开发人员[developer]调用了Action方法[preferencesInit]', 20120820232331, '/G4Studio/index.ered', 'preferencesInit', 354);
insert into EAEVENT (eventid, userid, account, username, description, activetime, requestpath, methodname, costtime)
values ('100000000033144', '10000001', 'developer', '开发人员', '开发人员[developer]打开了菜单[表格范例六(合计表格)]', 20120820232340, '/G4Studio/demo/gridDemo.ered', 'gridDemo6Init', 166);
insert into EAEVENT (eventid, userid, account, username, description, activetime, requestpath, methodname, costtime)
values ('100000000033146', '10000001', 'developer', '开发人员', '开发人员[developer]调用了Action方法[queryBalanceInfo]', 20120820232342, '/G4Studio/demo/gridDemo.ered', 'queryBalanceInfo', 151);
insert into EAEVENT (eventid, userid, account, username, description, activetime, requestpath, methodname, costtime)
values ('100000000033148', '10000001', 'developer', '开发人员', '开发人员[developer]调用了Action方法[sumBalanceInfo]', 20120820232342, '/G4Studio/demo/gridDemo.ered', 'sumBalanceInfo', 8);
insert into EAEVENT (eventid, userid, account, username, description, activetime, requestpath, methodname, costtime)
values ('100000000033150', '10000001', 'developer', '开发人员', '开发人员[developer]打开了菜单[系统预置图标]', 20120820232357, '/G4Studio/resource.ered', 'iconInit', 147);
insert into EAEVENT (eventid, userid, account, username, description, activetime, requestpath, methodname, costtime)
values ('100000000033152', '10000001', 'developer', '开发人员', '开发人员[developer]调用了Action方法[queryIconItems]', 20120820232357, '/G4Studio/resource.ered', 'queryIconItems', 44);
insert into EAEVENT (eventid, userid, account, username, description, activetime, requestpath, methodname, costtime)
values ('100000000033154', '10000001', 'developer', '开发人员', '开发人员[developer]打开了菜单[文件管理(上传下载)]', 20120820232414, '/G4Studio/demo/otherDemo.ered', 'uploadInit', 220);
insert into EAEVENT (eventid, userid, account, username, description, activetime, requestpath, methodname, costtime)
values ('100000000033156', '10000001', 'developer', '开发人员', '开发人员[developer]调用了Action方法[queryFileDatas]', 20120820232415, '/G4Studio/demo/otherDemo.ered', 'queryFileDatas', 34);
insert into EAEVENT (eventid, userid, account, username, description, activetime, requestpath, methodname, costtime)
values ('100000000033158', '10000001', 'developer', '开发人员', '开发人员[developer]调用了Action方法[doUpload]', 20120820232421, '/G4Studio/demo/otherDemo.ered', 'doUpload', 113);
insert into EAEVENT (eventid, userid, account, username, description, activetime, requestpath, methodname, costtime)
values ('100000000033160', '10000001', 'developer', '开发人员', '开发人员[developer]调用了Action方法[queryFileDatas]', 20120820232421, '/G4Studio/demo/otherDemo.ered', 'queryFileDatas', 41);
insert into EAEVENT (eventid, userid, account, username, description, activetime, requestpath, methodname, costtime)
values ('100000000033132', '10000001', 'developer', '开发人员', '开发人员[developer]调用了Action方法[deleteEvents]', 20120819005830, '/G4Studio/eventTrack.ered', 'deleteEvents', 65);
insert into EAEVENT (eventid, userid, account, username, description, activetime, requestpath, methodname, costtime)
values ('100000000033134', '10000001', 'developer', '开发人员', '开发人员[developer]调用了Action方法[queryEvents]', 20120819005831, '/G4Studio/eventTrack.ered', 'queryEvents', 13);
commit;
prompt 27 records loaded
prompt Loading EAEXCEPTION...
insert into EAEXCEPTION (exceptionid, clazz, methodname, exception, activetime)
values ('10000065', 'org.eredlab.g4.bmf.base.ReaderImpl', 'queryForPage', 'SqlMapClient operation; bad SQL grammar []; nested exception is com.ibatis.common.jdbc.exception.NestedSQLException:   ' || chr(10) || '--- The error occurred while applying a parameter map.  ' || chr(10) || '--- Check the Monitor.queryEventsByDto-InlineParameterMap.  ' || chr(10) || '--- Check the parameter map.  ' || chr(10) || '--- Cause: java.sql.SQLException: ORA-00907: 缺失右括号' || chr(10) || '', 20120819005200);
insert into EAEXCEPTION (exceptionid, clazz, methodname, exception, activetime)
values ('10000066', 'org.eredlab.g4.bmf.base.DaoImpl', 'delete', 'SqlMapClient operation; uncategorized SQLException for SQL []; SQL state [null]; error code [0];   ' || chr(10) || '--- The error occurred in org/eredlab/g4/arm/sqlmap/Monitor.xml.  ' || chr(10) || '--- The error occurred while preparing the mapped statement for execution.  ' || chr(10) || '--- Check the Monitor.deleteEvent.  ' || chr(10) || '--- Cause: java.sql.SQLException: Invalid parameter object type.  Expected ''java.util.Map'' but found ''java.lang.String''.; nested exception is com.ibatis.common.jdbc.exception.NestedSQLException:   ' || chr(10) || '--- The error occurred in org/eredlab/g4/arm/sqlmap/Monitor.xml.  ' || chr(10) || '--- The error occurred while preparing the mapped statement for execution.  ' || chr(10) || '--- Check the Monitor.deleteEvent.  ' || chr(10) || '--- Cause: java.sql.SQLException: Invalid parameter object type.  Expected ''java.util.Map'' but found ''java.lang.String''.', 20120819005725);
insert into EAEXCEPTION (exceptionid, clazz, methodname, exception, activetime)
values ('10000046', 'org.eredlab.g4.bmf.base.DaoImpl', 'queryForObject', 'There is no statement named Demo.queryBalanceInfo1 in this SqlMap.', 20120817114333);
insert into EAEXCEPTION (exceptionid, clazz, methodname, exception, activetime)
values ('10000050', 'org.eredlab.g4.bmf.base.DaoImpl', 'queryForObject', 'There is no statement named Demo.queryBalanceInfo1 in this SqlMap.', 20120817140039);
insert into EAEXCEPTION (exceptionid, clazz, methodname, exception, activetime)
values ('10000054', 'org.eredlab.g4.bmf.base.DaoImpl', 'delete', 'SqlMapClient operation; bad SQL grammar []; nested exception is com.ibatis.common.jdbc.exception.NestedSQLException:   ' || chr(10) || '--- The error occurred in org/eredlab/g4/arm/sqlmap/Monitor.xml.  ' || chr(10) || '--- The error occurred while applying a parameter map.  ' || chr(10) || '--- Check the Monitor.deleteBeanMonitorRecord-InlineParameterMap.  ' || chr(10) || '--- 请检查您的SQL语句 (update failed).  ' || chr(10) || '--- Cause: java.sql.SQLException: ORA-00942: 表或视图不存在' || chr(10) || '', 20120817141533);
insert into EAEXCEPTION (exceptionid, clazz, methodname, exception, activetime)
values ('10000055', 'org.eredlab.g4.arm.service.impl.MonitorServiceImpl', 'deleteMonitorData', 'SqlMapClient operation; bad SQL grammar []; nested exception is com.ibatis.common.jdbc.exception.NestedSQLException:   ' || chr(10) || '--- The error occurred in org/eredlab/g4/arm/sqlmap/Monitor.xml.  ' || chr(10) || '--- The error occurred while applying a parameter map.  ' || chr(10) || '--- Check the Monitor.deleteBeanMonitorRecord-InlineParameterMap.  ' || chr(10) || '--- 请检查您的SQL语句 (update failed).  ' || chr(10) || '--- Cause: java.sql.SQLException: ORA-00942: 表或视图不存在' || chr(10) || '', 20120817141533);
insert into EAEXCEPTION (exceptionid, clazz, methodname, exception, activetime)
values ('10000058', 'org.eredlab.g4.bmf.base.ReaderImpl', 'queryForPage', 'SqlMapClient operation; bad SQL grammar []; nested exception is com.ibatis.common.jdbc.exception.NestedSQLException:   ' || chr(10) || '--- The error occurred while applying a parameter map.  ' || chr(10) || '--- Check the Monitor.queryHttpSessions-InlineParameterMap.  ' || chr(10) || '--- Check the parameter mapping for the ''username'' property.  ' || chr(10) || '--- Cause: java.sql.SQLException: ORA-00907: 缺失右括号' || chr(10) || '', 20120819000141);
insert into EAEXCEPTION (exceptionid, clazz, methodname, exception, activetime)
values ('10000059', 'org.eredlab.g4.bmf.base.DaoImpl', 'insert', 'SqlMapClient operation; SQL [];   ' || chr(10) || '--- The error occurred in org/eredlab/g4/arm/sqlmap/Monitor.xml.  ' || chr(10) || '--- The error occurred while applying a parameter map.  ' || chr(10) || '--- Check the Monitor.saveEvent-InlineParameterMap.  ' || chr(10) || '--- Check the statement (update failed).  ' || chr(10) || '--- Cause: java.sql.SQLException: ORA-01722: 无效数字' || chr(10) || '; nested exception is com.ibatis.common.jdbc.exception.NestedSQLException:   ' || chr(10) || '--- The error occurred in org/eredlab/g4/arm/sqlmap/Monitor.xml.  ' || chr(10) || '--- The error occurred while applying a parameter map.  ' || chr(10) || '--- Check the Monitor.saveEvent-InlineParameterMap.  ' || chr(10) || '--- Check the statement (update failed).  ' || chr(10) || '--- Cause: java.sql.SQLException: ORA-01722: 无效数字' || chr(10) || '', 20120819004644);
insert into EAEXCEPTION (exceptionid, clazz, methodname, exception, activetime)
values ('10000060', 'org.eredlab.g4.arm.service.impl.MonitorServiceImpl', 'saveEvent', 'SqlMapClient operation; SQL [];   ' || chr(10) || '--- The error occurred in org/eredlab/g4/arm/sqlmap/Monitor.xml.  ' || chr(10) || '--- The error occurred while applying a parameter map.  ' || chr(10) || '--- Check the Monitor.saveEvent-InlineParameterMap.  ' || chr(10) || '--- Check the statement (update failed).  ' || chr(10) || '--- Cause: java.sql.SQLException: ORA-01722: 无效数字' || chr(10) || '; nested exception is com.ibatis.common.jdbc.exception.NestedSQLException:   ' || chr(10) || '--- The error occurred in org/eredlab/g4/arm/sqlmap/Monitor.xml.  ' || chr(10) || '--- The error occurred while applying a parameter map.  ' || chr(10) || '--- Check the Monitor.saveEvent-InlineParameterMap.  ' || chr(10) || '--- Check the statement (update failed).  ' || chr(10) || '--- Cause: java.sql.SQLException: ORA-01722: 无效数字' || chr(10) || '', 20120819004644);
insert into EAEXCEPTION (exceptionid, clazz, methodname, exception, activetime)
values ('10000061', 'org.eredlab.g4.bmf.base.DaoImpl', 'insert', 'SqlMapClient operation; SQL [];   ' || chr(10) || '--- The error occurred in org/eredlab/g4/arm/sqlmap/Monitor.xml.  ' || chr(10) || '--- The error occurred while applying a parameter map.  ' || chr(10) || '--- Check the Monitor.saveEvent-InlineParameterMap.  ' || chr(10) || '--- Check the statement (update failed).  ' || chr(10) || '--- Cause: java.sql.SQLException: ORA-01722: 无效数字' || chr(10) || '; nested exception is com.ibatis.common.jdbc.exception.NestedSQLException:   ' || chr(10) || '--- The error occurred in org/eredlab/g4/arm/sqlmap/Monitor.xml.  ' || chr(10) || '--- The error occurred while applying a parameter map.  ' || chr(10) || '--- Check the Monitor.saveEvent-InlineParameterMap.  ' || chr(10) || '--- Check the statement (update failed).  ' || chr(10) || '--- Cause: java.sql.SQLException: ORA-01722: 无效数字' || chr(10) || '', 20120819004753);
insert into EAEXCEPTION (exceptionid, clazz, methodname, exception, activetime)
values ('10000062', 'org.eredlab.g4.arm.service.impl.MonitorServiceImpl', 'saveEvent', 'SqlMapClient operation; SQL [];   ' || chr(10) || '--- The error occurred in org/eredlab/g4/arm/sqlmap/Monitor.xml.  ' || chr(10) || '--- The error occurred while applying a parameter map.  ' || chr(10) || '--- Check the Monitor.saveEvent-InlineParameterMap.  ' || chr(10) || '--- Check the statement (update failed).  ' || chr(10) || '--- Cause: java.sql.SQLException: ORA-01722: 无效数字' || chr(10) || '; nested exception is com.ibatis.common.jdbc.exception.NestedSQLException:   ' || chr(10) || '--- The error occurred in org/eredlab/g4/arm/sqlmap/Monitor.xml.  ' || chr(10) || '--- The error occurred while applying a parameter map.  ' || chr(10) || '--- Check the Monitor.saveEvent-InlineParameterMap.  ' || chr(10) || '--- Check the statement (update failed).  ' || chr(10) || '--- Cause: java.sql.SQLException: ORA-01722: 无效数字' || chr(10) || '', 20120819004753);
insert into EAEXCEPTION (exceptionid, clazz, methodname, exception, activetime)
values ('10000063', 'org.eredlab.g4.bmf.base.DaoImpl', 'insert', 'SqlMapClient operation; SQL [];   ' || chr(10) || '--- The error occurred in org/eredlab/g4/arm/sqlmap/Monitor.xml.  ' || chr(10) || '--- The error occurred while applying a parameter map.  ' || chr(10) || '--- Check the Monitor.saveEvent-InlineParameterMap.  ' || chr(10) || '--- Check the statement (update failed).  ' || chr(10) || '--- Cause: java.sql.SQLException: ORA-01722: 无效数字' || chr(10) || '; nested exception is com.ibatis.common.jdbc.exception.NestedSQLException:   ' || chr(10) || '--- The error occurred in org/eredlab/g4/arm/sqlmap/Monitor.xml.  ' || chr(10) || '--- The error occurred while applying a parameter map.  ' || chr(10) || '--- Check the Monitor.saveEvent-InlineParameterMap.  ' || chr(10) || '--- Check the statement (update failed).  ' || chr(10) || '--- Cause: java.sql.SQLException: ORA-01722: 无效数字' || chr(10) || '', 20120819005048);
insert into EAEXCEPTION (exceptionid, clazz, methodname, exception, activetime)
values ('10000064', 'org.eredlab.g4.arm.service.impl.MonitorServiceImpl', 'saveEvent', 'SqlMapClient operation; SQL [];   ' || chr(10) || '--- The error occurred in org/eredlab/g4/arm/sqlmap/Monitor.xml.  ' || chr(10) || '--- The error occurred while applying a parameter map.  ' || chr(10) || '--- Check the Monitor.saveEvent-InlineParameterMap.  ' || chr(10) || '--- Check the statement (update failed).  ' || chr(10) || '--- Cause: java.sql.SQLException: ORA-01722: 无效数字' || chr(10) || '; nested exception is com.ibatis.common.jdbc.exception.NestedSQLException:   ' || chr(10) || '--- The error occurred in org/eredlab/g4/arm/sqlmap/Monitor.xml.  ' || chr(10) || '--- The error occurred while applying a parameter map.  ' || chr(10) || '--- Check the Monitor.saveEvent-InlineParameterMap.  ' || chr(10) || '--- Check the statement (update failed).  ' || chr(10) || '--- Cause: java.sql.SQLException: ORA-01722: 无效数字' || chr(10) || '', 20120819005048);
commit;
prompt 13 records loaded
prompt Loading EAHELP...
prompt Table is empty
prompt Loading EAHTTPSESSION...
insert into EAHTTPSESSION (sessionid, username, account, createtime, loginip, userid, explorer)
values ('kr8fkjy9n7ia', '开发人员', 'developer', '2012-08-25 14:52:16', '127.0.0.1', '10000001', 'CHROME/18.0.');
commit;
...
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1095, 'INSERT INTO eaevent ( ' || chr(9) || '' || chr(9) || '   eventid, userid, account,  ' || chr(9) || '' || chr(9) || '   username, description, activetime,requestpath,methodname,costtime)  ' || chr(9) || '' || chr(9) || 'VALUES (''100000000033174'', ''10000001'', ''developer'',  ' || chr(9) || '' || chr(9) || '   ''开发人员'', ''开发人员[developer]调用了Action方法[deleteMonitorDatas]'', 20120825145228,''/G4Studio/jdbcMonitor.ered'',''deleteMonitorDatas'',113)', 20120825145228, 4, 1, '1');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1096, 'SELECT * FROM (SELECT page.*, ROWNUM AS rn FROM ( ' || chr(9) || '' || chr(9) || 'SELECT monitorid, sqltext as sqltext, starttime, costtime, effectrows, type             FROM eajdbcmonitor WHERE 1 = 1 ' || chr(9) || '' || chr(9) || '  ' || chr(9) || '' || chr(9) || '' || chr(9) || ' ' || chr(9) || '' || chr(9) || '' || chr(9) || '' || chr(9) || ' ' || chr(9) || '' || chr(9) || '' || chr(9) || ' ' || chr(9) || '' || chr(9) || '' || chr(9) || ' ' || chr(9) || '' || chr(9) || '' || chr(9) || ' ' || chr(9) || '' || chr(9) || '' || chr(9) || ' ' || chr(9) || '' || chr(9) || '  ' || chr(9) || '' || chr(9) || '     ORDER BY starttime desc ' || chr(9) || ') page) WHERE rn BETWEEN 1 AND 50', 20120825145228, 6, -1, '4');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1097, 'SELECT count(*) as count ' || chr(9) || '' || chr(9) || '  FROM eajdbcmonitor WHERE 1 = 1', 20120825145228, 4, -1, '4');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1098, 'UPDATE easequence SET maxid = ''100000000033175'' WHERE fieldname = ''EVENTID''', 20120825145228, 4, 1, '2');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1099, 'UPDATE easequence SET maxid = ''100000000033176'' WHERE fieldname = ''EVENTID''', 20120825145228, 2, 1, '2');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1100, 'INSERT INTO eaevent ( ' || chr(9) || '' || chr(9) || '   eventid, userid, account,  ' || chr(9) || '' || chr(9) || '   username, description, activetime,requestpath,methodname,costtime)  ' || chr(9) || '' || chr(9) || 'VALUES (''100000000033176'', ''10000001'', ''developer'',  ' || chr(9) || '' || chr(9) || '   ''开发人员'', ''开发人员[developer]调用了Action方法[queryMonitorData]'', 20120825145228,''/G4Studio/jdbcMonitor.ered'',''queryMonitorData'',37)', 20120825145228, 4, 1, '1');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1101, 'SELECT theme FROM eausersubinfo ' || chr(9) || '' || chr(9) || '  WHERE userid = ''10000001''', 20120825145238, 2, -1, '4');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1102, 'UPDATE easequence SET maxid = ''100000000033177'' WHERE fieldname = ''EVENTID''', 20120825145238, 2, 1, '2');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1103, 'SELECT             menuid, menuname, parentid,  ' || chr(9) || '' || chr(9) || '   iconcls, expanded, request,  ' || chr(9) || '' || chr(9) || '   leaf, sortno, remark,  ' || chr(9) || '' || chr(9) || '   icon' || chr(9) || '       ' || chr(9) || '' || chr(9) || ' FROM eamenu where menuid = ''01010406''', 20120825145238, 5, -1, '4');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1104, 'UPDATE easequence SET maxid = ''100000000033178'' WHERE fieldname = ''EVENTID''', 20120825145238, 1, 1, '2');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1105, 'INSERT INTO eaevent ( ' || chr(9) || '' || chr(9) || '   eventid, userid, account,  ' || chr(9) || '' || chr(9) || '   username, description, activetime,requestpath,methodname,costtime)  ' || chr(9) || '' || chr(9) || 'VALUES (''100000000033178'', ''10000001'', ''developer'',  ' || chr(9) || '' || chr(9) || '   ''开发人员'', ''开发人员[developer]打开了菜单[系统异常监控]'', 20120825145238,''/G4Studio/beanMonitor.ered'',''init'',312)', 20120825145238, 5, 1, '1');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1106, 'SELECT * FROM (SELECT page.*, ROWNUM AS rn FROM ( ' || chr(9) || '' || chr(9) || 'SELECT   exceptionid, clazz, methodname,  activetime, exception ' || chr(9) || '' || chr(9) || '    FROM eaexception a  ' || chr(9) || '' || chr(9) || ' WHERE 1 = 1 ' || chr(9) || '' || chr(9) || ' ' || chr(9) || '' || chr(9) || ' ' || chr(9) || '' || chr(9) || '' || chr(9) || '' || chr(9) || ' ' || chr(9) || '' || chr(9) || '' || chr(9) || '' || chr(9) || ' ' || chr(9) || '' || chr(9) || '' || chr(9) || '    ' || chr(9) || ' ' || chr(9) || '' || chr(9) || '  ' || chr(9) || '' || chr(9) || 'ORDER BY exceptionid DESC ' || chr(9) || ') page) WHERE rn BETWEEN 1 AND 50', 20120825145238, 11, -1, '4');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1107, 'SELECT count(*) as count ' || chr(9) || '' || chr(9) || '  FROM eaexception a WHERE 1 = 1', 20120825145238, 3, -1, '4');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1108, 'UPDATE easequence SET maxid = ''100000000033179'' WHERE fieldname = ''EVENTID''', 20120825145238, 4, 1, '2');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1109, 'UPDATE easequence SET maxid = ''100000000033180'' WHERE fieldname = ''EVENTID''', 20120825145238, 1, 1, '2');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1110, 'INSERT INTO eaevent ( ' || chr(9) || '' || chr(9) || '   eventid, userid, account,  ' || chr(9) || '' || chr(9) || '   username, description, activetime,requestpath,methodname,costtime)  ' || chr(9) || '' || chr(9) || 'VALUES (''100000000033180'', ''10000001'', ''developer'',  ' || chr(9) || '' || chr(9) || '   ''开发人员'', ''开发人员[developer]调用了Action方法[queryMonitorDatas]'', 20120825145238,''/G4Studio/beanMonitor.ered'',''queryMonitorDatas'',51)', 20120825145238, 2, 1, '1');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1111, 'DELETE  ' || chr(9) || '' || chr(9) || '  FROM eaexception WHERE 1 = 1 ' || chr(9) || '' || chr(9) || '  ' || chr(9) || '' || chr(9) || ' ' || chr(9) || '' || chr(9) || '' || chr(9) || '' || chr(9) || 'and ' || chr(9) || '' || chr(9) || '' || chr(9) || '' || chr(9) || '     exceptionid = ''10000067''', 20120825145247, 3, 1, '3');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1112, 'DELETE  ' || chr(9) || '' || chr(9) || '  FROM eaexception WHERE 1 = 1 ' || chr(9) || '' || chr(9) || '  ' || chr(9) || '' || chr(9) || ' ' || chr(9) || '' || chr(9) || '' || chr(9) || '' || chr(9) || 'and ' || chr(9) || '' || chr(9) || '' || chr(9) || '' || chr(9) || '     exceptionid = ''10000053''', 20120825145247, 1, 1, '3');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1113, 'DELETE  ' || chr(9) || '' || chr(9) || '  FROM eaexception WHERE 1 = 1 ' || chr(9) || '' || chr(9) || '  ' || chr(9) || '' || chr(9) || ' ' || chr(9) || '' || chr(9) || '' || chr(9) || '' || chr(9) || 'and ' || chr(9) || '' || chr(9) || '' || chr(9) || '' || chr(9) || '     exceptionid = ''10000052''', 20120825145247, 2, 1, '3');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1114, 'DELETE  ' || chr(9) || '' || chr(9) || '  FROM eaexception WHERE 1 = 1 ' || chr(9) || '' || chr(9) || '  ' || chr(9) || '' || chr(9) || ' ' || chr(9) || '' || chr(9) || '' || chr(9) || '' || chr(9) || 'and ' || chr(9) || '' || chr(9) || '' || chr(9) || '' || chr(9) || '     exceptionid = ''10000051''', 20120825145247, 2, 1, '3');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1115, 'DELETE  ' || chr(9) || '' || chr(9) || '  FROM eaexception WHERE 1 = 1 ' || chr(9) || '' || chr(9) || '  ' || chr(9) || '' || chr(9) || ' ' || chr(9) || '' || chr(9) || '' || chr(9) || '' || chr(9) || 'and ' || chr(9) || '' || chr(9) || '' || chr(9) || '' || chr(9) || '     exceptionid = ''10000049''', 20120825145247, 1, 1, '3');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1116, 'DELETE  ' || chr(9) || '' || chr(9) || '  FROM eaexception WHERE 1 = 1 ' || chr(9) || '' || chr(9) || '  ' || chr(9) || '' || chr(9) || ' ' || chr(9) || '' || chr(9) || '' || chr(9) || '' || chr(9) || 'and ' || chr(9) || '' || chr(9) || '' || chr(9) || '' || chr(9) || '     exceptionid = ''10000048''', 20120825145247, 1, 1, '3');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1117, 'DELETE  ' || chr(9) || '' || chr(9) || '  FROM eaexception WHERE 1 = 1 ' || chr(9) || '' || chr(9) || '  ' || chr(9) || '' || chr(9) || ' ' || chr(9) || '' || chr(9) || '' || chr(9) || '' || chr(9) || 'and ' || chr(9) || '' || chr(9) || '' || chr(9) || '' || chr(9) || '     exceptionid = ''10000047''', 20120825145247, 3, 1, '3');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1118, 'UPDATE easequence SET maxid = ''100000000033181'' WHERE fieldname = ''EVENTID''', 20120825145247, 47, 1, '2');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1119, 'UPDATE easequence SET maxid = ''100000000033182'' WHERE fieldname = ''EVENTID''', 20120825145247, 1, 1, '2');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1120, 'INSERT INTO eaevent ( ' || chr(9) || '' || chr(9) || '   eventid, userid, account,  ' || chr(9) || '' || chr(9) || '   username, description, activetime,requestpath,methodname,costtime)  ' || chr(9) || '' || chr(9) || 'VALUES (''100000000033182'', ''10000001'', ''developer'',  ' || chr(9) || '' || chr(9) || '   ''开发人员'', ''开发人员[developer]调用了Action方法[deleteMonitorDatas]'', 20120825145247,''/G4Studio/beanMonitor.ered'',''deleteMonitorDatas'',38)', 20120825145247, 3, 1, '1');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1121, 'SELECT * FROM (SELECT page.*, ROWNUM AS rn FROM ( ' || chr(9) || '' || chr(9) || 'SELECT   exceptionid, clazz, methodname,  activetime, exception ' || chr(9) || '' || chr(9) || '    FROM eaexception a  ' || chr(9) || '' || chr(9) || ' WHERE 1 = 1 ' || chr(9) || '' || chr(9) || ' ' || chr(9) || '' || chr(9) || ' ' || chr(9) || '' || chr(9) || '' || chr(9) || '' || chr(9) || ' ' || chr(9) || '' || chr(9) || '' || chr(9) || '' || chr(9) || ' ' || chr(9) || '' || chr(9) || '' || chr(9) || '    ' || chr(9) || ' ' || chr(9) || '' || chr(9) || '  ' || chr(9) || '' || chr(9) || 'ORDER BY exceptionid DESC ' || chr(9) || ') page) WHERE rn BETWEEN 1 AND 50', 20120825145247, 10, -1, '4');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1122, 'SELECT count(*) as count ' || chr(9) || '' || chr(9) || '  FROM eaexception a WHERE 1 = 1', 20120825145247, 2, -1, '4');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1123, 'UPDATE easequence SET maxid = ''100000000033183'' WHERE fieldname = ''EVENTID''', 20120825145247, 2, 1, '2');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1124, 'UPDATE easequence SET maxid = ''100000000033184'' WHERE fieldname = ''EVENTID''', 20120825145247, 1, 1, '2');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1125, 'INSERT INTO eaevent ( ' || chr(9) || '' || chr(9) || '   eventid, userid, account,  ' || chr(9) || '' || chr(9) || '   username, description, activetime,requestpath,methodname,costtime)  ' || chr(9) || '' || chr(9) || 'VALUES (''100000000033184'', ''10000001'', ''developer'',  ' || chr(9) || '' || chr(9) || '   ''开发人员'', ''开发人员[developer]调用了Action方法[queryMonitorDatas]'', 20120825145247,''/G4Studio/beanMonitor.ered'',''queryMonitorDatas'',45)', 20120825145247, 1, 1, '1');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1092, 'DELETE  ' || chr(9) || '' || chr(9) || '  FROM eajdbcmonitor where 1 = 1', 20120825145228, 8, 1090, '3');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1093, 'UPDATE easequence SET maxid = ''100000000033173'' WHERE fieldname = ''EVENTID''', 20120825145228, 11, 1, '2');
insert into EAJDBCMONITOR (monitorid, sqltext, starttime, costtime, effectrows, type)
values (1094, 'UPDATE easequence SET maxid = ''100000000033174'' WHERE fieldname = ''EVENTID''', 20120825145228, 4, 1, '2');
commit;
prompt 34 records loaded
prompt Loading EAMENU...
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021316', '图表综合范例一(动态数据源)', '010213', null, '0', 'demo/flashReportDemo.ered?reqCode=integrateFlashReport1Init', '1', 16, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021317', '图表综合范例二(动态数据源)', '010213', null, '0', 'demo/flashReportDemo.ered?reqCode=integrateFlashReport2Init', '1', 17, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('010214', '页面布局', '0102', null, '0', null, '0', 7, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021401', 'Form布局', '010214', null, '0', 'demo/formDemo.ered?reqCode=formLayoutInit', '1', 1, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021402', 'Column布局', '010214', null, '0', 'demo/formDemo.ered?reqCode=columnLayoutInit', '1', 2, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021403', '表单综合布局1', '010214', null, '0', 'demo/formDemo.ered?reqCode=complexLayoutInit', '1', 3, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021404', '表单综合布局2', '010214', null, '0', 'demo/formDemo.ered?reqCode=complexLayout2Init', '1', 4, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021405', 'Viewport布局', '010214', null, '0', 'demo/commonUiDemo.ered?reqCode=viewportLayoutInit', '1', 5, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021406', 'Viewport嵌套布局', '010214', null, '0', 'demo/commonUiDemo.ered?reqCode=viewportComplexLayoutInit', '1', 6, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('010215', '综合', '0102', null, '0', null, '0', 8, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021501', '综合实例1', '010215', null, '0', 'demo/integrateDemo.ered?reqCode=queryDemo1Init', '1', 1, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021502', '综合实例2', '010215', null, '0', 'demo/integrateDemo.ered?reqCode=queryDemo2Init', '1', 2, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021503', '综合实例3', '010215', null, '0', 'demo/integrateDemo.ered?reqCode=collectDataInit', '1', 3, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021504', '综合实例4', '010215', null, '0', 'demo/integrateDemo.ered?reqCode=collectDataByWindowInit', '1', 4, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021505', '综合实例5', '010215', null, '0', 'demo/integrateDemo.ered?reqCode=manageDataInit', '1', 5, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021506', '综合实例6', '010215', null, '0', 'demo/integrateDemo.ered?reqCode=manageData4In1Init', '1', 6, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('010216', '其它', '0102', null, '0', null, '0', 9, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021601', '存储过程调用', '010216', null, '0', 'demo/integrateDemo.ered?reqCode=callPrcInit', '1', 1, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021602', '文件管理(上传下载)', '010216', null, '0', 'demo/otherDemo.ered?reqCode=uploadInit', '1', 2, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021603', '演示UI元素授权', '010216', null, '0', 'demo/integrateDemo.ered?reqCode=manageData4In1Init', '1', 3, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('0103', '开发人员工具箱', '01', 'configIcon', '0', null, '0', 3, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('010301', '其它', '0103', null, '0', null, '0', 8, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01030101', '系统预置图标', '010301', 'imagesIcon', '0', 'resource.ered?reqCode=iconInit', '1', 1, null, 'images.png', '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01030102', '调色板', '010301', 'theme2Icon', '0', 'resource.ered?reqCode=colorPaletteInit', '1', 2, null, 'theme2.png', '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('010302', '调试', '0103', null, '0', null, '0', 9, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01030201', '调试页面1', '010302', null, '0', 'demo/test.ered?reqCode=test1Init', '1', 1, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01030202', '调试页面2', '010302', null, '0', 'demo/test.ered?reqCode=test2Init', '1', 2, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01030203', '调试页面3', '010302', null, '0', 'demo/test.ered?reqCode=test3Init', '1', 3, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01030204', '调试页面4', '010302', null, '0', 'demo/test.ered?reqCode=test4Init', '1', 4, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01030205', '调试页面5', '010302', null, '0', 'demo/test.ered?reqCode=test5Initt', '1', 5, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01030301', '菜单1', '010303', null, '0', null, '1', 0, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01030401', '菜单1', '010304', null, '0', null, '1', 1, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021318', '拆线组合图（双Y轴）', '010213', null, '0', 'demo/flashReportDemo.ered?reqCode=fcfLineMs2YInit', '1', 19, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021319', '动态切换图表类型', '010213', null, '0', 'demo/flashReportDemo.ered?reqCode=integrateFlashReport3Init', '1', 18, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021604', '导入Excel文件(xls格式)', '010216', null, '0', 'demo/excelReportDemo.ered?reqCode=importInit', '1', 4, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('010303', '代码生成', '0103', null, '0', null, '0', 1, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('010304', '数据管理', '0103', null, '0', null, '0', 2, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021605', '客户端请求异常处理', '010216', null, '0', 'demo/otherDemo.ered?reqCode=exceptionInit', '1', 5, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01', 'G4Studio系统集成与开发平台', '0', null, '0', null, '0', 1, null, null, '1');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('0101', '系统管理', '01', 'folder_wrenchIcon', '0', null, '0', 1, null, null, '1');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('010102', '权限管理', '0101', null, '1', null, '0', 1, null, null, '1');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01010201', '组织机构管理', '010102', 'chart_organisationIcon', '0', 'organization.ered?reqCode=departmentInit', '1', 1, null, 'chart_organisation.png', '1');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01010202', '人员管理与授权', '010102', 'group_linkIcon', '0', 'user.ered?reqCode=userInit', '1', 3, null, 'group_link.png', '1');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01010204', '角色管理与授权', '010102', 'award_star_silver_3Icon', '0', 'role.ered?reqCode=roleInit', '1', 2, null, 'award_star_silver_3.png', '1');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01010205', '菜单资源管理', '010102', 'arrow_switchIcon', '0', 'resource.ered?reqCode=menuResourceInit', '1', 4, null, 'arrow_switch.png', '1');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01010206', 'UI元素托管', '010102', 'app_boxesIcon', '0', 'part.ered?reqCode=init', '1', 5, null, 'app_boxes.png', '1');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01010207', 'UI元素角色授权', '010102', 'app_leftIcon', '0', 'rolePart.ered?reqCode=init', '1', 6, null, 'app_left.png', '1');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01010208', 'UI元素人员授权', '010102', 'app_rightIcon', '0', 'userPart.ered?reqCode=init', '1', 7, null, 'app_right.png', '1');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('010103', '基础数据维护', '0101', null, '1', null, '0', 2, null, null, '1');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01010301', '字典维护', '010103', 'application_view_listIcon', '0', 'resource.ered?reqCode=codeTableInit', '1', 1, null, 'application_view_list.png', '1');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01010303', '全局参数表维护', '010103', 'configIcon', '0', 'param.ered?reqCode=init', '1', 2, null, 'config.png', '1');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('010104', '运行监控', '0101', null, '1', null, '0', 3, null, null, '1');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01010401', 'Session会话监控', '010104', 'user_commentIcon', '0', 'sessionMonitor.ered?reqCode=init', '1', 2, null, 'user_comment.png', '1');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01010403', 'Requst请求跟踪', '010104', 'bugIcon', '0', 'eventTrack.ered?reqCode=init', '1', 1, null, 'bug.png', '1');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01010405', 'JDBC执行监控', '010104', 'database_refreshIcon', '0', 'jdbcMonitor.ered?reqCode=jdbcInit', '1', 3, null, 'database_refresh.png', '1');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01010406', '系统异常监控', '010104', 'disconnectIcon', '0', 'beanMonitor.ered?reqCode=init', '1', 4, null, 'disconnect.png', '1');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01010407', '服务器信息', '010104', 'server_connectIcon', '0', 'serverInfo.ered?reqCode=init', '1', 5, null, 'server_connect.png', '1');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('0102', '标准范例子系统', '01', 'folder_cameraIcon', '0', null, '0', 2, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('010208', '表单及表单元素', '0102', null, '0', null, '0', 1, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01020801', '基本输入(属性配置)', '010208', null, '0', 'demo/formDemo.ered?reqCode=basicInput4PropertyInit', '1', 1, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01020802', '基本输入(方法行为)', '010208', null, '0', 'demo/formDemo.ered?reqCode=basicInput4MethodInit', '1', 2, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01020803', '日历选择框(日期、时间)', '010208', null, '0', 'demo/formDemo.ered?reqCode=dataTimeInputInit', '1', 3, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01020804', '下拉选择框(本地数据源)', '010208', null, '0', 'demo/formDemo.ered?reqCode=selectInputBasedLocalDataSourceInit', '1', 4, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01020805', '下拉选择框(字典数据源)', '010208', null, '0', 'demo/formDemo.ered?reqCode=selectInputBasedCodeTableDataSourceInit', '1', 5, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01020806', '下拉选择框(远程数据源)', '010208', null, '0', 'demo/formDemo.ered?reqCode=selectInputBasedRemoteDataSourceInit', '1', 6, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01020807', '下拉选择框(N级联动)', '010208', null, '0', 'demo/formDemo.ered?reqCode=selectInputBasedMultilevelInit', '1', 7, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01020808', '单选框、复选框', '010208', null, '0', 'demo/formDemo.ered?reqCode=radioCheckBoxInit', '1', 8, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01020809', '表单异步交互(提交、数据填充)', '010208', null, '0', 'demo/formDemo.ered?reqCode=formSubmitInit', '1', 9, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01020810', '表单同步提交', '010208', null, '0', 'demo/formDemo.ered?reqCode=formSynSubmitInit', '1', 10, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01020813', '工具栏、菜单栏', '010208', null, '0', 'demo/formDemo.ered?reqCode=toobarDemo1Init', '1', 11, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01020814', '消息对话框', '010208', null, '0', 'demo/formDemo.ered?reqCode=msgDemo1Init', '1', 12, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01020815', '富文本输入框', '010208', null, '0', 'demo/formDemo.ered?reqCode=htmlEditorInit', '1', 13, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01020816', '富文本输入框(扩展)', '010208', null, '0', 'demo/formDemo.ered?reqCode=htmlEditor2Init', '1', 14, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('010209', '窗口及面板', '0102', null, '0', null, '0', 2, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01020901', '面板范例一', '010209', null, '0', 'demo/commonUiDemo.ered?reqCode=panelDemo1Init', '1', 1, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01020902', '窗口范例一', '010209', null, '0', 'demo/commonUiDemo.ered?reqCode=windowDemo1Init', '1', 2, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01020903', 'Tab标签卡范例一', '010209', null, '0', 'demo/commonUiDemo.ered?reqCode=tabPanelDemo1Init', '1', 3, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('010210', '表格', '0102', null, '0', null, '0', 3, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021001', '表格范例一(基本特性)', '010210', null, '0', 'demo/gridDemo.ered?reqCode=gridDemo1Init', '1', 1, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021002', '表格范例二(行级展开)', '010210', null, '0', 'demo/gridDemo.ered?reqCode=gridDemo2Init', '1', 2, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021003', '表格范例三(可编辑表格)', '010210', null, '0', 'demo/gridDemo.ered?reqCode=gridDemo3Init', '1', 3, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021004', '表格范例四(列锁定)', '010210', null, '0', 'demo/gridDemo.ered?reqCode=gridDemo4Init', '1', 4, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021005', '表格范例五(缓冲表格)', '010210', null, '0', 'demo/gridDemo.ered?reqCode=gridDemo5Init', '1', 5, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021006', '表格范例六(合计表格)', '010210', null, '0', 'demo/gridDemo.ered?reqCode=gridDemo6Init', '1', 6, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021007', '表格范例七(表头分组)', '010210', null, '0', 'demo/gridDemo.ered?reqCode=gridDemo7Init', '1', 7, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('010211', '树', '0102', null, '0', null, '0', 4, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021101', '树范例一(普通树)', '010211', null, '0', 'demo/treeDemo.ered?reqCode=treeDemo1Init', '1', 1, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021102', '树范例二(异步树)', '010211', null, '0', 'demo/treeDemo.ered?reqCode=treeDemo2Init', '1', 2, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021103', '树范例三(复选树)', '010211', null, '0', 'demo/treeDemo.ered?reqCode=treeDemo3Init', '1', 3, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021104', '树范例四(级联复选树)', '010211', null, '0', 'demo/treeDemo.ered?reqCode=treeDemo4Init', '1', 4, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021105', '树范例五(下拉树)', '010211', null, '0', 'demo/treeDemo.ered?reqCode=treeDemo5Init', '1', 5, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021106', '树范例六(异步表格树)', '010211', null, '0', 'demo/treeDemo.ered?reqCode=treeDemo6Init', '1', 6, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021107', '树范例七(下拉树2)', '010211', null, '0', 'demo/treeDemo.ered?reqCode=treeDemo8Init', '1', 7, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('010212', '报表', '0102', null, '0', null, '0', 5, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021201', 'Applet报表', '010212', null, '0', 'demo/jasperReportDemo.ered?reqCode=appletInit', '1', 1, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021202', 'PDF报表', '010212', null, '0', 'demo/jasperReportDemo.ered?reqCode=pdfInit', '1', 2, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021203', 'Excel报表', '010212', null, '0', 'demo/excelReportDemo.ered?reqCode=exportInit', '1', 3, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('010213', '图表', '0102', null, '0', null, '0', 6, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021301', '2D柱状图', '010213', null, '0', 'demo/flashReportDemo.ered?reqCode=fcf2DColumnInit', '1', 1, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021302', '3D柱状图', '010213', null, '0', 'demo/flashReportDemo.ered?reqCode=fcf3DColumnInit', '1', 2, null, null, '0');
commit;
prompt 100 records committed...
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021303', '2D饼图', '010213', null, '0', 'demo/flashReportDemo.ered?reqCode=fcf2DPieInit', '1', 3, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021304', '3D饼图', '010213', null, '0', 'demo/flashReportDemo.ered?reqCode=fcf3DPieInit', '1', 4, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021305', '2D柱状组合图', '010213', null, '0', 'demo/flashReportDemo.ered?reqCode=fcf2DColumnMsInit', '1', 5, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021306', '3D柱状组合图', '010213', null, '0', 'demo/flashReportDemo.ered?reqCode=fcf3DColumnMsInit', '1', 6, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021307', '折线图', '010213', null, '0', 'demo/flashReportDemo.ered?reqCode=fcfLineInit', '1', 7, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021308', '折线组合图', '010213', null, '0', 'demo/flashReportDemo.ered?reqCode=fcfLineMsInit', '1', 8, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021309', '面积图', '010213', null, '0', 'demo/flashReportDemo.ered?reqCode=fcfAreaInit', '1', 9, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021310', '面积组合图', '010213', null, '0', 'demo/flashReportDemo.ered?reqCode=fcfAreaMsInit', '1', 10, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021311', '环状图', '010213', null, '0', 'demo/flashReportDemo.ered?reqCode=fcfCircularityInit', '1', 11, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021312', '3D折线柱状交叉图', '010213', null, '0', 'demo/flashReportDemo.ered?reqCode=fcf3DLineColumnInit', '1', 12, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021313', '2D栏位图', '010213', null, '0', 'demo/flashReportDemo.ered?reqCode=fcf2DBarInit', '1', 13, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021314', '2D栏位组合图', '010213', null, '0', 'demo/flashReportDemo.ered?reqCode=fcf2DBarMsInit', '1', 14, null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype)
values ('01021315', '交互图(JS调用|下钻[超链接])', '010213', null, '0', 'demo/flashReportDemo.ered?reqCode=fcfAdvancedInit', '1', 15, null, null, '0');
commit;
...
insert into EAPARAM (paramid, paramkey, paramvalue, remark)
values ('10000017', 'SYS_TITLE', 'G4Studio：系统集成与行业应用快速开发平台', '系统标题');
insert into EAPARAM (paramid, paramkey, paramvalue, remark)
values ('10000018', 'LOGIN_WINDOW_TITLE', 'G4Studio - 系统集成与行业应用快速开发平台', '登录窗口标题');
insert into EAPARAM (paramid, paramkey, paramvalue, remark)
...
insert into EAPARAM (paramid, paramkey, paramvalue, remark)
values ('10000021', 'BOTTOM_COPYRIGHT', 'Copyright 2008 XiongChun 中国.昆明', '右下角的版权信息');
insert into EAPARAM (paramid, paramkey, paramvalue, remark)
values ('10000022', 'MENU_FIRST', 'G4Studio', '中心面板导航菜单的第一个节点名');
insert into EAPARAM (paramid, paramkey, paramvalue, remark)
values ('10000023', 'WELCOME_PAGE_TITLE', '我的工作台', '缺省欢迎页面的标题');
insert into EAPARAM (paramid, paramkey, paramvalue, remark)
values ('10000024', 'INDEX_BANNER', '/resource/image/eRedG4_Title_2.png', '首页Banner图片,必须为透明的PNG图片,建议尺寸:600 X 58');
insert into EAPARAM (paramid, paramkey, paramvalue, remark)
...
insert into EAPARAM (paramid, paramkey, paramvalue, remark)
values ('10000030', 'EXCEPTION_CLIENT_MSG', '很遗憾的通知您：服务器发生了错误，您提交的请求处理失败。请和我们的客服联系，客服支持电话：911。我们将在第一时间为您处理。', '客户端异常响应概要信息');
commit;
...
insert into EASEQUENCE (sequenceid, fieldname, maxid, remark, pattern, idtype)
values ('1003', 'PARAMID', '10000031', '参数ID', '00000000', '1');
insert into EASEQUENCE (sequenceid, fieldname, maxid, remark, pattern, idtype)
...
insert into EASEQUENCE (sequenceid, fieldname, maxid, remark, pattern, idtype)
values ('1009', 'EVENTID', '100000000033184', '事件ID', '000000000000000', '1');
insert into EASEQUENCE (sequenceid, fieldname, maxid, remark, pattern, idtype)
...
insert into EAUSERSUBINFO (userid, theme)
values ('10000000', 'lightRed');
insert into EAUSERSUBINFO (userid, theme)
values ('10000001', 'purple2');
insert into EAUSERSUBINFO (userid, theme)
values ('10004885', null);
insert into EAUSERSUBINFO (userid, theme)
values ('10004886', null);
insert into EAUSERSUBINFO (userid, theme)
values ('10004887', null);
insert into EAUSERSUBINFO (userid, theme)
values ('10004888', null);
insert into EAUSERSUBINFO (userid, theme)
values ('10004889', null);
insert into EAUSERSUBINFO (userid, theme)
values ('10004890', null);
commit;
prompt 8 records loaded
...
insert into EA_DEMO_FCF (name, value, color, alpha, issliced, product, fcfid)
values ('一月', '150000', 'AFD8F8', null, '0', '2', 13);
insert into EA_DEMO_FCF (name, value, color, alpha, issliced, product, fcfid)
values ('二月', '20000', 'F6BD0F', null, '0', '2', 14);
insert into EA_DEMO_FCF (name, value, color, alpha, issliced, product, fcfid)
values ('三月', '50000', 'FF8E46', null, '0', '2', 15);
insert into EA_DEMO_FCF (name, value, color, alpha, issliced, product, fcfid)
values ('四月', '9000', '008E8E', null, '0', '2', 16);
insert into EA_DEMO_FCF (name, value, color, alpha, issliced, product, fcfid)
values ('五月', '85000', 'D64646', null, '1', '2', 17);
insert into EA_DEMO_FCF (name, value, color, alpha, issliced, product, fcfid)
values ('六月', '10000', '8E468E', '60', '0', '2', 18);
insert into EA_DEMO_FCF (name, value, color, alpha, issliced, product, fcfid)
values ('七月', '40000', '588526', null, '0', '2', 19);
insert into EA_DEMO_FCF (name, value, color, alpha, issliced, product, fcfid)
values ('八月', '78000', 'B3AA00', null, '1', '2', 20);
insert into EA_DEMO_FCF (name, value, color, alpha, issliced, product, fcfid)
values ('九月', '112000', '008ED6', null, '0', '2', 21);
insert into EA_DEMO_FCF (name, value, color, alpha, issliced, product, fcfid)
values ('十月', '172000', '9D080D', null, '0', '2', 22);
insert into EA_DEMO_FCF (name, value, color, alpha, issliced, product, fcfid)
values ('十一月', '10000', 'A186BE', null, '0', '2', 23);
insert into EA_DEMO_FCF (name, value, color, alpha, issliced, product, fcfid)
values ('十二月', '50000', '1EBE38', null, '0', '2', 24);
commit;
...
insert into EA_DEMO_UPLOAD (fileid, title, path, filesize, remark)
values ('10000111', '1_110922230749_1.jpg', 'E:\G4\svn\web\WebRoot\uploaddata/2012-08-20/1_110922230749_1.jpg', 63933, null);
commit;

prompt G4Studio开源平台Oralce数据脚本初始化成功.